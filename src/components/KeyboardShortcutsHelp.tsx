    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* 内容 */}
          <div className="relative bg-gray-900/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 w-full max-w-sm mx-4 shadow-2xl animate-fade-in">
            ...
            <div className="space-y-2">
              {shortcuts.map((shortcut) => (
                ...
                >
                  ...
                  <kbd className="px-2.5 py-1 bg-white/10 border border-white/20 rounded-md text-xs font-mono text-white/90 min-w-[2rem] text-center">
                    {shortcut.key}
                  </kbd>
                </div>
              ))}
